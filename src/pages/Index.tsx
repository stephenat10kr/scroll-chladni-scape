...
const Index = () => {
  return (
    <>
      {/* Red Box Placeholder with normal scrolling */}
      <div className="bg-[#ea384c] min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-5xl md:text-7xl font-bold mb-6 text-white">Red Box Placeholder</h2>
          <p className="text-xl md:text-2xl text-white max-w-2xl mx-auto">
            This is a placeholder component with normal scrolling behavior.
          </p>
        </div>
      </div>
