    ...
    <div className="flex flex-col">
      ...
      <div className="bg-blue-500 min-h-[200vh] w-full flex items-center justify-center">
        <div className="container mx-auto px-4 py-12 text-center">
          <h1 className="text-6xl md:text-7xl font-bold mb-8 text-white">Blue Section</h1>
          <p className="text-2xl text-white max-w-2xl mx-auto">
            This section scrolls normally until you reach the Chladni pattern with scroll-jacking behavior.
          </p>
        </div>
      </div>
