...
const Index = () => {
  return (
    <div className="flex flex-col w-full">
      {/* Blue box content that appears before the scroll-jacking */}
      <div className="bg-[#0EA5E9] min-h-screen w-full flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-5xl md:text-7xl font-bold mb-6 text-white">Blue Box Content</h2>
          <p className="text-xl md:text-2xl text-white max-w-2xl mx-auto">
            This content appears before scrolling to the scroll-jacked sections. Scroll down to experience the scroll-jacking effect.
          </p>
        </div>
      </div>
      ...
      <div className="relative w-full">
        <ChladniPattern>
          ...
          {/* Red box content that appears after scroll-jacking */}
          <div className="bg-[#ea384c] min-h-screen w-full flex items-center justify-center">
            <div className="text-center">
