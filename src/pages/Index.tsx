...
const Index = () => {
  return (
    <>
      {/* Blue section that scrolls normally */}
      <div className="bg-blue-500 min-h-[100vh] flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-5xl md:text-7xl font-bold mb-6 text-white">Blue Section</h2>
          <p className="text-xl md:text-2xl text-white max-w-2xl mx-auto">
            This blue section appears at the top of the page and scrolls normally.
          </p>
        </div>
      </div>
